...
# --- UTILIDADES COPIADAS DE TIMM PARA NO DEPENDER DE LA LIBRERÍA ---
...
def _no_grad_trunc_normal_(tensor, mean, std, a, b):
    # Método auxiliar para inicialización de pesos
    def norm_cdf(x):
...
def trunc_normal_(tensor, mean=0., std=1., a=-2., b=2.):
    # Inicialización Truncada Normal (usada en los pesos del Transformer)
